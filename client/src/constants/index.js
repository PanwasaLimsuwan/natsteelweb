...
//   return <div dangerouslySetInnerHTML={{ __html: description.replace('</ br>', '<br>') }} />;
// };

// const ProductDescription = ({ description }) => {
//   const processedDescription = description.replace('<br>', '<br/>');
...
export const allproduct = [
  {
    ...
    work1: "กั้นแนวพื้นที่ที่ต้องกันความโปร่ง",
    work2: "กั้นรั้วบ้าน สถานที่ราชการ แนวรถไฟฟ้า แนวทางด่วน สวนสาธารณะ",
    work3: "กั้นเพื่อกันสัตว์ เช่น นก หนู หรือคอกสัตว์",
    // cat: "สินค้าประเภทลวดตาข่าย",
    cat: "ตาข่ายทอ chain link",
    // link: "/category1",
  },
